...
import itertools
from crawler.AtomicCounter import Counter
from crawler.WebScraper import scrape_page, scrape_links, scrape_info
...
class WebCrawler:
    ...
    def store_crawled_pages(self):
        with open("crawler/uic-web-graph/crawled_pages.txt", "w") as f:
